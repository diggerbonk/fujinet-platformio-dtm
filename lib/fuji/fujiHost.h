...
public:
    ...
    uint8_t get_menu_entry_type() { return _menu.get_menu_entry_type(); };
    ...
    // Directory functions
    bool dir_open(const char *path, const char *pattern, uint16_t options = 0, bool usefujimenu = false);
    void dir_close();
