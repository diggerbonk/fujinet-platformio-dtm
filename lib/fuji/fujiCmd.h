...
#define FUJICMD_OPEN_MENU 0xD0
#define FUJICMD_SET_MENU_POSITION 0xCF
#define FUJICMD_GET_MENU_POSITION 0xCE
#define FUJICMD_READ_MENU_ENTRY 0xCD
#define FUJICMD_CLOSE_MENU 0xCC
